...
{
    private function authenticateClient(): string
    {
        $client = static::createClient();

        $loginData = [
            'email' => 'dahbi.essakali@gmail.com',
            'password' => '07101992'
        ];
    ...
    public function testCreateBlogArticle(): void
    {
        ...
        $jwtToken = $this->authenticateClient();
